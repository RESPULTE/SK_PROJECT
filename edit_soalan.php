...
$pillhSoalan = mysqli_query($hubung, "SELECT * FROM soalan WHERE idsoalan=$soalan_terpilih");	
while($dataSoalan = mysqli_fetch_array($pillhSoalan)){
//Paparkan nilai asal
...
<a href="edit_soalanl.php?idsoalan=<?php echo $soalan_terpilih;?>"> <button>EDIT</button></a>
