...
//TOTAL SOALAN
  $query1 = "SELECT * FROM soalan WHERE idtopik=$topik_pilihan AND jenis=$jenis";
  $results = mysqli_query($hubung,$query1); 
  $total=mysqli_num_rows($results);
//TETAPKAN NOM SOALAN
     $number = (int)$_GET['n'];
// DAPATAN SOALAN
     $query2 = "SELECT * FROM soalan WHERE nom_soalan = $number AND idtopik=$topik_pilihan
AND jenis=$jenis"; 
//PAPAR RESULAT
...
?>
     ...
     ?>
<input type="text" name="idJAWAPAN" placeholder=
"Taip Jawapan Di sini" size='70%'>
     <?php } ?>
